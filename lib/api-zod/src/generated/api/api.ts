 ...
 */
export const getMyPortalSessionsQueryLimitDefault = 50;
export const getMyPortalSessionsQueryOffsetDefault = 0;

export const GetMyPortalSessionsQueryParams = zod.object({
  limit: zod.coerce.number().default(getMyPortalSessionsQueryLimitDefault),
  offset: zod.coerce.number().default(getMyPortalSessionsQueryOffsetDefault),
});

export const GetMyPortalSessionsResponseItem = zod.object({
  id: zod.number(),
...
export const GetMyPortalSessionsResponse = zod.array(
  GetMyPortalSessionsResponseItem,
);
 ...
 */
export const DeleteMyPortalSessionParams = zod.object({
  id: zod.coerce.number(),
});

export const DeleteMyPortalSessionResponse = zod.object({
  deleted: zod.boolean(),
  id: zod.number(),
});
